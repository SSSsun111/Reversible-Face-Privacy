...
parser.add_argument('-input_dir', type=str, default='/root/autodl-tmp/pulse/real',
                    help='directory with unprocessed images')
parser.add_argument('-output_dir', type=str, default='/root/autodl-tmp/pulse/inputtest', help='output directory')
...
parser.add_argument('-cache_dir', type=str, default='/root/autodl-tmp/pulse/cache',
...
# 直接使用已下载的模型文件
predictor_path = os.path.join(args.cache_dir, "shape_predictor_68_face_landmarks.dat")
print(f"使用现有的Shape Predictor模型: {predictor_path}")
