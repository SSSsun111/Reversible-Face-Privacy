...
#I/O arguments
parser.add_argument('-input_dir', type=str, default='/root/autodl-tmp/pulse/REALDATA2', help='input data directory')
parser.add_argument('-output_dir', type=str, default='/root/autodl-tmp/pulse/runsreal2', help='output data directory')
parser.add_argument('-cache_dir', type=str, default='/root/autodl-tmp/pulse/cache', help='cache directory for model weights')
...
# Initialize PULSE model with the cache_dir for loading existing model
